...
module TopologicalInventoryApiClient
  class Vm
    ...
    def hash
      [id, name, description, source_created_at, source_deleted_at, source_id, source_ref, tenant_id, uid_ems, hostname, power_state, cpus, memory, orchestration_stack_id, flavor_id, taggings].hash
    end
