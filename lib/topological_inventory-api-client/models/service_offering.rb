...
module TopologicalInventoryApiClient
  class ServiceOffering
    ...
    def hash
      [id, name, description, display_name, distributor, documentation_url, long_description, support_url, source_ref, extra, source_created_at, source_deleted_at, source_id, tenant_id, service_offering_icon_id, taggings].hash
    end
