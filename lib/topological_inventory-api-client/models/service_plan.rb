...
module TopologicalInventoryApiClient
  class ServicePlan
    ...
    def hash
      [id, name, description, extra, source_created_at, source_deleted_at, source_id, source_ref, tenant_id, service_offering_id, create_json_schema, update_json_schema].hash
    end
